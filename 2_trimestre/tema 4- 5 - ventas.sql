...
-- 11- Muestra la columna password para cada cliente, formada por los caracteres 3 y 4 del nombre y de los apellidos y la categoria.
-- Añade el campo en la tabla y almacénalo. Con IFNULL() y conversiones de tipos

select *, conca(substr(nombre,3,2),
