...
truncate(precio * 1.04,2) as "dolares"
from producto;
...
select nombre as "nombre minusculas",
upper(substr(nombre, 1, 2)) as " 2mayusculas",
upper(substr(nombre, 3, length(nombre)-2)) as " mayusculas"
from producto;
...
truncate(precio, 2) as "precio_truncado"
from producto;
...
select 12, nombre, precio, dodigo_fabricante
from producto
where codigo=1
*/
