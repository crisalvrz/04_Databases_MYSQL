...
select distinct codigo_cliente, year(fecha_pago) as anio
from pago
...
from pedido
where estado = 'Rechazado' and fecha_entrega like '2009%';

-- 12. Devuelve un listado de todos los pedidos que han sido entregados en el mes de enero de cualquier año.

select codigo_pedido, estado
from pedido
where estado= 'Entregado' and fecha_entrega like '%-01-%';
...
select nombre_cliente, codigo_empleado_rep_ventas
from cliente
where codigo_empleado_rep_ventas = 11 or codigo_empleado_rep_ventas = 30 and ciudad like 'Madrid';
